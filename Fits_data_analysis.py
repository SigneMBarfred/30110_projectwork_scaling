# -*- coding: utf-8 -*-
"""
Created on Sun Mar 26 17:58:28 2023
...
G10_flux = np.array([data['GALEX_NUV_FLUX'],data['CFHT_u_FLUX'],
...
G10_fluxerr = np.array([data['GALEX_NUV_FLUXERR'],data['CFHT_u_FLUXERR'],
