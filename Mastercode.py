...
SFR_SF_cat1_p = ax1.hexbin(mass_SF_cat1, np.log10(SFR_SF_cat1),vmax = 5, cmap = "Blues", mincnt = 1, gridsize=(173,100), zorder = 1)
SFR_Q_cat1_p = ax1.hexbin(mass_Q_cat1, np.log10(SFR_Q_cat1),vmax = 5, cmap = "Reds", mincnt = 1, gridsize=(173,100), zorder = 0)
trendpoints_our_cat1 = ax1.scatter(Mass_ave_cat1,SFR_ave_cat1, c='gold', s = 60, marker = 'x')

trend_our_cat1 = ax1.plot(Mass_ave_cat1,pINT1(Mass_ave_cat1),color="limegreen", linewidth=2, linestyle="-",label='Regression',zorder=100)
trend_paper_cat1 = ax1.plot(logmass,logSF1,c="magenta",ls="-.",lw=2, label= 'Speagle')
...
SFR_SF_cat2_p = ax2.hexbin(mass_SF_cat2, np.log10(SFR_SF_cat2),vmax = 35, cmap = "Blues", mincnt = 1, gridsize=(173,100), zorder = 1)
SFR_Q_cat2_p = ax2.hexbin(mass_Q_cat2, np.log10(SFR_Q_cat2),vmax = 5, cmap = "Reds", mincnt = 1, gridsize=(173,100), zorder = 0)
trendpoints_our_cat2 = ax2.scatter(Mass_ave_cat2,SFR_ave_cat2, c='gold', s = 60, marker = 'x')

trend_our_cat2 = ax2.plot(Mass_ave_cat2,pINT2(Mass_ave_cat2),color="limegreen", linewidth=2, linestyle="-",label='Regression',zorder=100)
trend_paper_cat2 = ax2.plot(logmass,logSF2,c="magenta",ls="-.",lw=2, label= 'Speagle')
...
SFR_SF_cat3_p = ax3.hexbin(mass_SF_cat3, np.log10(SFR_SF_cat3),vmax = 35, cmap = "Blues", mincnt = 1, gridsize=(173,100), zorder = 1)
SFR_Q_cat3_p = ax3.hexbin(mass_Q_cat3, np.log10(SFR_Q_cat3),vmax = 5, cmap = "Reds", mincnt = 1, gridsize=(173,100), zorder = 0)
trendpoints_our_cat3 = ax3.scatter(Mass_ave_cat3, SFR_ave_cat3, c='gold', s = 60, marker = 'x')

trend_our_cat3 = ax3.plot(Mass_ave_cat3,pINT3(Mass_ave_cat3),color="limegreen", linewidth=2, linestyle="-",label='Regression',zorder=100)
trend_paper_cat3 = ax3.plot(logmass,logSF3,c="magenta",ls="-.",lw=2, label= 'Speagle')
...
SFR_SF_cat4_p = ax4.hexbin(mass_SF_cat4, np.log10(SFR_SF_cat4),vmax = 35, cmap = "Blues", mincnt = 1, gridsize=(173,100), zorder = 1)
SFR_Q_cat4_p = ax4.hexbin(mass_Q_cat4, np.log10(SFR_Q_cat4),vmax = 5, cmap = "Reds", mincnt = 1, gridsize=(173,100), zorder = 0)
trendpoints_our_cat4 = ax4.scatter(Mass_ave_cat4, SFR_ave_cat4, c='gold', s = 60, marker = 'x')

trend_our_cat4 = ax4.plot(Mass_ave_cat4,pINT4(Mass_ave_cat4),color="limegreen", linewidth=2, linestyle="-",label='Regression',zorder=100)
trend_paper_cat4 = ax4.plot(logmass,logSF4,c="magenta",ls="-.",lw=2, label= 'Speagle')
...
SFR_SF_cat5_p = ax5.hexbin(mass_SF_cat5, np.log10(SFR_SF_cat5),vmax = 35, cmap = "Blues", mincnt = 1, gridsize=(173,100), zorder = 1)
SFR_Q_cat5_p = ax5.hexbin(mass_Q_cat5, np.log10(SFR_Q_cat5),vmax = 3, cmap = "Reds", mincnt = 1, gridsize=(173,100), zorder = 0)
trendpoints_our_cat5 = ax5.scatter(Mass_ave_cat5, SFR_ave_cat5, c='gold', s = 60, marker = 'x')

trend_our_cat5 = ax5.plot(Mass_ave_cat5,pINT5(Mass_ave_cat5),color="limegreen", linewidth=2, linestyle="-",label='Regression',zorder=100)
trend_paper_cat5 = ax5.plot(logmass,logSF5,c="magenta",ls="-.",lw=2, label= 'Speagle')
