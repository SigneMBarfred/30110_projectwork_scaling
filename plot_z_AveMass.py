...
# 0 < z < 0.5
mean_mass_nSF_cat1 = np.mean(np.log10(m1[~IDS_cat1]))
mean_mass_nQ_cat1 = np.mean(np.log10(m1[IDS_cat1]))
...
mean_mass_nSF_cat2 = (np.mean(np.log10(mean_mass_cat2_lower[~IDS_cat2_lower]))+np.mean(np.log10(mean_mass_cat2_upper[~IDS_cat2_upper])))/2
mean_mass_nQ_cat2 = (np.mean(np.log10(mean_mass_cat2_lower[IDS_cat2_lower]))+np.mean(np.log10(mean_mass_cat2_upper[IDS_cat2_upper])))/2
...
# 0.5 < z < 1
mean_mass_nSF_cat3 = np.mean(np.log10(m3[~IDS_cat3]))
mean_mass_nQ_cat3 = np.mean(np.log10(m3[IDS_cat3]))
...
mean_mass_nSF_cat4 = (np.mean(np.log10(mean_mass_cat4_lower[~IDS_cat4_lower]))+np.mean(np.log10(mean_mass_cat4_upper[~IDS_cat4_upper])))/2
mean_mass_nQ_cat4 = (np.mean(np.log10(mean_mass_cat4_lower[IDS_cat4_lower]))+np.mean(np.log10(mean_mass_cat4_upper[IDS_cat4_upper])))/2
...
mean_mass_nSF_cat5 = np.mean(np.log10(mean_mass_cat5[~IDS_cat5]))
mean_mass_nQ_cat5 = np.mean(np.log10(mean_mass_cat5[IDS_cat5]))
...
mean_mass_nSF_cat6 = np.mean(np.log10(mean_mass_cat6[~IDS_cat6]))
mean_mass_nQ_cat6 = np.mean(np.log10(mean_mass_cat6[IDS_cat6]))
...
mean_mass_nSF_cat7 = np.mean(np.log10(mean_mass_cat7[~IDS_cat7]))
mean_mass_nQ_cat7 = np.mean(np.log10(mean_mass_cat7[IDS_cat7]))
...
mean_mass_nSF_cat8 = (np.mean(np.log10(mean_mass_cat8_lower[~IDS_cat8_lower]))+np.mean(np.log10(mean_mass_cat8_upper[~IDS_cat8_upper])))/2
mean_mass_nQ_cat8 = (np.mean(np.log10(mean_mass_cat8_lower[IDS_cat8_lower]))+np.mean(np.log10(mean_mass_cat8_upper[IDS_cat8_upper])))/2
...
mean_mass_nSF_cat9 = np.mean(np.log10(mean_mass_cat9[~IDS_cat9]))
mean_mass_nQ_cat9 = np.mean(np.log10(mean_mass_cat9[IDS_cat9]))
...
mean_mass_nSF_cat10 = np.mean(np.log10(mean_mass_cat10[~IDS_cat10]))
mean_mass_nQ_cat10 = np.mean(np.log10(mean_mass_cat10[IDS_cat10]))
...
mean_mass_nSF_cat11 = np.mean(np.log10(mean_mass_cat11[~IDS_cat11]))
mean_mass_nQ_cat11 = np.mean(np.log10(mean_mass_cat11[IDS_cat11]))
...
mean_mass_nSF_cat12 = np.mean(np.log10(mean_mass_cat12[~IDS_cat12]))
mean_mass_nQ_cat12 = np.mean(np.log10(mean_mass_cat12[IDS_cat12]))
...
mean_mass_nSF_cat13 = np.mean(np.log10(mean_mass_cat13[~IDS_cat13]))
mean_mass_nQ_cat13 = np.mean(np.log10(mean_mass_cat13[IDS_cat13]))
...
mean_mass_nSF_cat14 = np.mean(np.log10(mean_mass_cat14[~IDS_cat14]))
mean_mass_nQ_cat14 = np.mean(np.log10(mean_mass_cat14[IDS_cat14]))
...
mean_mass_nSF_cat15 = np.mean(np.log10(mean_mass_cat15[~IDS_cat15]))
mean_mass_nQ_cat15 = np.mean(np.log10(mean_mass_cat15[IDS_cat15]))
